...
function create({  nickName, credit, email, role, password }) {
    const user = {  nickName, credit, email, role, password };
...
function update(id, { nickName, credit, email, role, password }) {
    const params = { nickName, credit, email, role, password };
